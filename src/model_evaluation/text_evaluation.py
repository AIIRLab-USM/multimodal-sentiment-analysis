...
state_dict_paths = [
    f'models{os.path.sep}bert-dict.pt',
    f'models{os.path.sep}bal-training_bert-dict.pt'
]
...
def main():
    ...
    for state_dict_path, data_path in zip(state_dict_paths, data_paths):
        save_name = 'text' if state_dict_path==state_dict_paths[0] \
            else 'bal-training_text'
